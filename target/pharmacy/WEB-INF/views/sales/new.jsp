...
<c:set var="pageTitle" value="Add New Sale" />

<div class="main-content">
    <div class="container-fluid px-4">
        <h2>${pageTitle}</h2>
        <form method="post" action="${pageContext.request.contextPath}/sales/new">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="totalAmount" name="totalAmount" readonly value="0.00" />
            </div>
