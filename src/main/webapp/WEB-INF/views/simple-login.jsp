...
<head>
    ...
    <title>PharmaTrack - Pharmacy Management System</title>
...
<body>
    <div class="main-container">
        ...
        <div class="pharmacy-image">
            <img src="${pageContext.request.contextPath}/resources/img/AA.jpg" alt="Pharmacy Image"
        ...
        <div class="login-section">
            <div class="login-form-container">
                ...
                <c:if test="${not empty hasTriedLogin and not empty error}">
                ...
                <form action="${pageContext.request.contextPath}/login" method="post" novalidate>
                    ...
                    <div class="form-check remember-me">
                        ...
                        <label for="remember" class="form-check-label">Remember password</label>
                    </div>
